...
export function FeatureShowcase() {
  ...
  const features = [
    {
      ...
      icon: BookOpen,
      iconStyle: isLight ? 'text-sky-600 bg-sky-50 border-sky-200' : 'text-sky-400 bg-sky-500/10 border-sky-500/30',
      exploreUrl: '/learn',
    ...
    },
    {
      ...
      icon: Code2,
      iconStyle: isLight ? 'text-blue-600 bg-blue-50 border-blue-200' : 'text-blue-400 bg-blue-500/10 border-blue-500/30',
      exploreUrl: '/practice',
    ...
    },
    {
      ...
      icon: BarChart3,
      iconStyle: isLight ? 'text-teal-600 bg-teal-50 border-teal-200' : 'text-teal-400 bg-teal-500/10 border-teal-500/30',
    ...
    },
    {
      ...
      icon: RotateCcw,
      iconStyle: isLight ? 'text-emerald-600 bg-emerald-50 border-emerald-200' : 'text-emerald-400 bg-emerald-500/10 border-emerald-500/30',
      exploreUrl: '/revision',
    ...
    },
    {
      ...
      icon: Brain,
      iconStyle: isLight ? 'text-purple-600 bg-purple-50 border-purple-200' : 'text-purple-400 bg-purple-500/10 border-purple-500/30',
      exploreUrl: '/mentor',
  ...
  return (
    <section id="features" className={`py-24 relative border-t transition-colors duration-200 ${
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <p className={`text-base sm:text-lg leading-relaxed pt-2 ${
            ...
            Five core pillars designed to make your DSA journey structured, measurable, and stress-free.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className={`group relative flex flex-col justify-between rounded-2xl border p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 ${
                  isLight
              ...
              >
                <div>
                  ...
                  {/* Title */}
                  <h3 className={`text-base font-bold mb-2 leading-snug ${isLight ? 'text-slate-900' : 'text-white'}`}>
                    {feature.title}
                  </h3>
                ...
                {/* Subtle Explore Link */}
                <div className={`pt-6 mt-4 border-t ${isLight ? 'border-slate-100' : 'border-slate-800/60'}`}>
                  <Link
                    href={feature.exploreUrl}
                    className={`inline-flex items-center gap-1 text-xs font-semibold transition-colors group-hover:underline underline-offset-4 ${
