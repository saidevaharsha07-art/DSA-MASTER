...
const BASE_CATEGORIES = [
  { id: 'cat-1', slug: 'basic-arrays', title: 'Array', kingdomTitle: 'Kingdom of Beginnings', description: 'Master continuous memory, array indexing, and element manipulation.', order: 1, patternIds: ['pattern.array-fundamentals', 'pattern.kadanes-algorithm', 'pattern.array-rearrangement', 'pattern.array-simulation-design'] },
  ...
  { id: 'cat-12', slug: 'binary-trees', title: 'Binary Tree', kingdomTitle: 'The Branching Woods', description: 'Tree traversal, recursive properties, construction & serialization, and tree views.', order: 12, patternIds: ['pattern.tree-traversal', 'pattern.recursive-tree-properties', 'pattern.tree-construction', 'pattern.root-to-leaf-paths', 'pattern.tree-views-levels'] },
  { id: 'cat-13', slug: 'binary-search-trees', title: 'Binary Search Tree', kingdomTitle: 'The Ordered Grove', description: 'BST fundamentals, BST traversal & order statistics, LCA, and BST modification.', order: 13, patternIds: ['pattern.bst-fundamentals', 'pattern.bst-traversal-order', 'pattern.lca-structural-bst', 'pattern.bst-modification'] },
  { id: 'cat-14', slug: 'graphs', title: 'Graph', kingdomTitle: 'Shadow Forest', description: 'Graph representation & traversal, topological sort, Union-Find, and bipartite coloring.', order: 14, patternIds: ['pattern.graph-traversal', 'pattern.topological-sort', 'pattern.union-find', 'pattern.bipartite-coloring', 'pattern.advanced-graph-traversal', 'pattern.graph-construction-multi-bfs'] },
  { id: 'cat-15', slug: 'shortest-path', title: 'Shortest Path', kingdomTitle: 'The Swift Roads', description: 'BFS shortest path, Dijkstra algorithm, Bellman-Ford, and 0-1 BFS.', order: 15, patternIds: ['pattern.bfs-shortest-path', 'pattern.dijkstras-algorithm', 'pattern.bellman-ford', 'pattern.a-star-01-bfs', 'pattern.modified-dijkstra-variants'] },
  ...
  { id: 'cat-19', slug: 'heap', title: 'Heap / Priority Queue', kingdomTitle: 'The Summit Fortress', description: 'Top-K elements, two-heap technique, heap for scheduling, and heap design.', order: 19, patternIds: ['pattern.top-k-elements', 'pattern.two-heap', 'pattern.heap-scheduling', 'pattern.heap-design-simulation'] },
